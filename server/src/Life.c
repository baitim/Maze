...
Object_t OBJECTS[COUNT_OBJECTS] = {
    {SYM_OBJ_WALL,      COUNT_OBJ_INF,      0,  20,  0, {}},
    {SYM_OBJ_ROAD,      COUNT_OBJ_INF,      1,  5,   0, {}},
    {SYM_OBJ_BORDER,    COUNT_OBJ_INF,      0,  100, 0, {}},
    {SYM_OBJ_PLAYER,    COUNT_OBJ_PLAYER,   1,  0,   0, {}},
    {SYM_OBJ_COIN,      COUNT_OBJ_COIN,     1,  10,  0, {}},
    {SYM_OBJ_LAMP,      COUNT_OBJ_LAMP,     0,  0,   2, {SYM_OBJ_WALL}},
    {SYM_OBJ_PATH,      COUNT_OBJ_PATH,     1,  0,   0, {}},
    {SYM_OBJ_DEST,      COUNT_OBJ_PATH,     1,  0,   0, {}},
    {SYM_OBJ_IMDEST,    COUNT_OBJ_PATH,     1,  0,   0, {}},
    {SYM_OBJ_TUNNEL,    COUNT_OBJ_INF,      1,  5,   0, {}},
    {SYM_OBJ_ERR,       COUNT_OBJ_INF,      0,  0,   0, {}},
    {SYM_OBJ_SCREAM,    COUNT_OBJ_SCREAM,   1,  0,   0, {}}
};
...
static ErrorCode map_fill_empty         (char* map);
...
static ErrorCode make_hills(Map_t* map)
{
    ...
    for (int pos = 0; pos < SCREEN_BYTES_COUNT; pos++) {
        if (map->map[pos] == SYM_OBJ_WALL) {
            ...
            map->shadow[pos] = (unsigned int)MIN(255, MAX(0, ((MAX_HILL_HEIGHT - MIN(MAX_HILL_HEIGHT, height)) * HILL_SLOPE)));
        }
    }
    return ERROR_NO;
}
