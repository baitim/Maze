#ifndef SERVER_SRC_CONFIG_H
#define SERVER_SRC_CONFIG_H
...
typedef enum PlayerStatus_t_ {
    PLAYER_STATUS_EXIT  = 0,
    PLAYER_STATUS_EXIST = 1
} PlayerStatus_t;
...
extern PlayerSet_t players[MAX_PLAYERS];
